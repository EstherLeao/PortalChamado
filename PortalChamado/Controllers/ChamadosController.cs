...
namespace PortalChamado.Controllers
{
    public class ChamadosController : Controller
    {
        ...
        public ChamadosController(PortalChamadoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdChamado,LoginCriador,Carteira,Quantidade,LoginTratamento,Texto,Assunto,Importancia,DataInicio,DataResposta,Status")] Chamado chamado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdChamado,LoginCriador,Carteira,Quantidade,LoginTratamento,Texto,Assunto,Importancia,DataInicio,DataResposta,Status")] Chamado chamado)
        {
